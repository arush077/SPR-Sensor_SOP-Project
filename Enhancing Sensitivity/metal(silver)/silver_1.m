%changing thickness of silver for each run
...
%             nc=1.743    %SF11
           ...
           % IMP positioning of layers starts from here
            ...
            ngr=2.974-2.803*1i;
            nbp=3.0945-1i*1.58369;
            nfg=2.62563-1i*1e-6; 
            nsb=1.696;
            nmx=2.1095-1i*1.1338;
            nmos2=3.647;
            nag=0.514-10.8*1i;
          ...
          %changing thickness of silver for each run
            depth=[40e-9,7e-9,dsb,td];
            nr = [nag,nSTO,nsb,nd];  % Ridge refractive index for each grating
            ng = [nag,nSTO,nsb,nd];  % Groove refractive index for each grating
